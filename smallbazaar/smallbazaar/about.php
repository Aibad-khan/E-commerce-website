    ...
    <div class="container mt-5 ">
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          <h3 class="text-warning pt-3 title">Who am i?</h3>
          <hr />
          
          <p class="mt-2">Hello friends,my name is Aibad Khan  and i am pre final year student at Jaypee Institute Of Information Technoloy.i am a passionate programmer who loves coding and solving real life problems.</p>
        </div>
        <div class="col-md-5 mt-3">
